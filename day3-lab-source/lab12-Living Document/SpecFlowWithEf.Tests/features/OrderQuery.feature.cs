...
#line hidden
        ...
        public virtual void TestInitialize()
        {
            ...
            {
                SpecFlowWithEf.Tests.Features.OrderQueryFeature.FeatureSetup(null);
            }
        }
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("依據姓名、訂單日期起的條件，查出顧客的訂單")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "OrderQuery")]
        public virtual void 依據姓名訂單日期起的條件查出顧客的訂單()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("依據姓名、訂單日期起的條件，查出顧客的訂單", ((string[])(null)));
#line 25
this.ScenarioSetup(scenarioInfo);
#line hidden
            ...
            table5.AddRow(new string[] {
                        ...
                        ""});
#line 26
 testRunner.Given("查詢條件為", ((string)(null)), table5, "Given ");
#line hidden
            ...
            table6.AddRow(new string[] {
                        ...
                        "SkillTree"});
#line 29
 testRunner.And("預計Customers資料應有", ((string)(null)), table6, "And ");
#line hidden
            ...
            table7.AddRow(new string[] {
                        ...
                        "Changhua"});
#line 32
 testRunner.And("預計Orders資料應有", ((string)(null)), table7, "And ");
#line 39
 testRunner.When("呼叫Query方法", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
            ...
            table8.AddRow(new string[] {
                        ...
                        "Changhua"});
#line 40
 testRunner.Then("查詢結果應為", ((string)(null)), table8, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("依據姓名、訂單日期迄的條件，查出顧客的訂單")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "OrderQuery")]
        public virtual void 依據姓名訂單日期迄的條件查出顧客的訂單()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("依據姓名、訂單日期迄的條件，查出顧客的訂單", ((string[])(null)));
#line 47
this.ScenarioSetup(scenarioInfo);
#line hidden
            ...
            table9.AddRow(new string[] {
                        ...
                        "2014-07-04"});
#line 48
 testRunner.Given("查詢條件為", ((string)(null)), table9, "Given ");
#line hidden
            ...
            table10.AddRow(new string[] {
                        ...
                        "SkillTree"});
#line 51
 testRunner.And("預計Customers資料應有", ((string)(null)), table10, "And ");
#line hidden
            ...
            table11.AddRow(new string[] {
                        ...
                        "Changhua"});
#line 54
 testRunner.And("預計Orders資料應有", ((string)(null)), table11, "And ");
#line 61
 testRunner.When("呼叫Query方法", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
            ...
            table12.AddRow(new string[] {
                        ...
                        "Changhua"});
#line 62
 testRunner.Then("查詢結果應為", ((string)(null)), table12, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
